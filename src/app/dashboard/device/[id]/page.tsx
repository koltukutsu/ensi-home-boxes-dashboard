                    ...
                    <CardContent>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {formatDate(snapshot.system_boot_time)}
                                </p>
                            </div>
                            <div>
                                <p className="text-sm text-muted-foreground">
                            ...
                            <div>
                                ...
                                <p className="font-medium">
                                    {snapshot.devices_devices?.length || 0}
                                </p>
                            </div>
                        </div>
                    </CardContent>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="w-full bg-muted rounded-full h-2.5">
                                    <div
                                        ...
                                        style={{
                                            width: `${snapshot.system_cpu_percent || 0}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="flex justify-between mb-1">
                                    ...
                                    <span className="text-sm font-medium">
                                        ...
                                        (
                                        {snapshot.system_memory_percent?.toFixed(
                                            1,
                                        ) || 0}
                                        %)
                                    </span>
                                ...
                                <div className="w-full bg-muted rounded-full h-2.5">
                                    <div
                                        ...
                                        style={{
                                            width: `${snapshot.system_memory_percent || 0}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div className="flex justify-between mb-1">
                                    ...
                                    <span className="text-sm font-medium">
                                        {formatBytes(snapshot.system_swap_used)}{" "}
                                        /{" "}
                                        {formatBytes(
                                            snapshot.system_swap_total,
                                        )}
                                        (
                                        {snapshot.system_swap_percent?.toFixed(
                                            1,
                                        ) || 0}
                                        %)
                                    </span>
                                ...
                                <div className="w-full bg-muted rounded-full h-2.5">
                                    <div
                                        ...
                                        style={{
                                            width: `${snapshot.system_swap_percent || 0}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
